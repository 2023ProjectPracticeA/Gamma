...
public class ProgG32Eqtn2 {
    public static void main(String[] args) {
        ...
        double a, b;
        Complex2 aComplex, bComplex, cComplex;
        ...
        switch (degree) {
            ...
            case 2:
                ...
                a = getValidatedDoubleInput(scanner, " 実部 >>");
                b = getValidatedDoubleInput(scanner, " 虚部 >> ");
                cComplex = new Complex2(a, b);

                ComplexQuadraticEquation quadEquation = new ComplexQuadraticEquation(aComplex, bComplex, cComplex);
                quadEquation.solve();
                System.out.println();
                System.out.println("方程式：");
                quadEquation.dispEq();
